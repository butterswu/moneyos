    ...
    function(e) {
        ...
        o.modules = {},
            ...
            t.fn.use = function(e, t, a) {
                function s(e, t) {
                    var n = "PLaySTATION 3" === navigator.platform ? /^complete$/: /^(complete|loaded)$/; ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[y] = t, m.removeChild(p),
                        function i() {
                ...
                window.jQuery && jQuery.fn.on && (d.each(e,
                    function(t, n) {
                ...
                return p.async = !0,
                    ...
                    o.modules[y] ? !
                        ...
                        } () : (m.appendChild(p), !p.attachEvent || p.attachEvent.toString && p.attachEvent.toString().indexOf("[native code") < 0 || u ? p.addEventListener("load",
                        function(e) {
                            s(e, h)
                        },
            ...
            t.fn.link = function(e, t, i) {
                ...
                "function" == typeof t && !
                    function f() {
                        return++d > 1e3 * o.timeout / 100 ? r(e + " timeout") : void(1989 === parseInt(u.getStyle(n.getElementById(c), "width")) ?
                            function() {
                                t()
                            } () : setTimeout(f, 100))
                    } ()
